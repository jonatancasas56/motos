        ...
        <div class="row">
            <div class="col-6 contorno">
                <div class="image-container">
                    <img src="assets/tornado.jpg" class="img-fluid"/>
                </div>
            </div>
            <div class="col-6 contorno">
                <div class="text-container">
                    <p>Características de la moto:</p>
                        <ul>
                            <li>Motor:	Monocilíndrico, DOHC, 4 tiempos, refrigerado por aire</li>
                            <li>Cilindrada:	249 cc</li>
                            <li>Potencia máxima:	23 cv a 7.500 rpm</li>
                            <li>Velocidad máxima:	130 km/h</li>
                            <li>Alimentación:	Carburador</li>
                            <li>Encendido:	CDI (Ignición por descarga capacitiva)</li>
                            <li>Arranque:	Eléctrico</li>
                            <li>Transmisión:	6 velocidades</li>
                        </ul>
                </div>
            </div>
        </div>
