        ...
        <div class="row">
            <div class="col-6 contorno">
                <div class="image-container">
                    <img src="assets/wave.jpg" class="img-fluid"/>
                </div>
            </div>
            <div class="col-6 contorno">
                <div class="text-container">
                    <p>Características de la moto:</p>
                        <ul>
                            <li>Motor:	Monocilíndrico, 4 tiempos, 2 válvulas, OHC, refrigerado por aire</li>
                            <li>Cilindrada:	109,1 cc</li>
                            <li>Potencia máxima:	9,3 cv @ 7.500 rpm</li>
                            <li>Velocidad máxima:	85 km/h</li>
                            <li>Alimentación:	Carburador</li>
                            <li>Encendido:	CDI y avance electrónico</li>
